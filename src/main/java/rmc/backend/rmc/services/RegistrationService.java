...
public class RegistrationService {
    ...
    public RegistrationService(RUserService rUserService,
    ...
    public String register(RegisterRequest request) {
        ...
        String token = rUserService.registerUser(
                new RUser(
    ...
    public String verifyToken(String token) {
        VerifyToken verifyToken = verifyTokenService
                .getToken(token)
                .orElseThrow(() ->
        ...
        rUserService.enableRUser(
                verifyToken.getRUser().getEmail());
    ...
    public ResponseEntity<LoginResponse> login(LoginRequest request) throws IllegalAccessException {
        ...
        if (rUser.isPresent()) {
            ...
            LoginResponse res = new LoginResponse(accessToken, isAdmin, new UserDetailsResponse(
                    rUser.get().getId(),
                    rUser.get().getEmail(),
                    rUser.get().getPassword(),
                    rUser.get().getNickname(),
                    rUser.get().getAvatar(),
                    rUser.get().getUserRole(),
                    rUser.get().getEnabled(),
                    rUser.get().getLocked()
            ));
